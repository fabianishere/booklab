...
class SoftHybridRecommenderTest {
    ...
    fun `default test`() {
        ...
        runBlocking {
            ...
            assertEquals(candidates[4], results[2])
    ...
    @Test
    fun `authors are ranked higher than ratings if rating is sufficiently high`() {
        val collection = listOf(
            Book(listOf(Title("title 3")), listOf("GREAT_AUTHOR"), listOf("666"))
        )
        val candidates = listOf(
            Book(listOf(Title("title 1")), listOf("author"), listOf("234"), 5.0),
            Book(listOf(Title("title 0")), listOf("GREAT_AUTHOR"), listOf("123"), 4.5)
        )
    ...
    @Test
    fun `authors are ranked lower than ratings if rating is sufficiently low`() {
        val collection = listOf(
            Book(listOf(Title("title 3")), listOf("GREAT_AUTHOR"), listOf("666"))
        )
        val candidates = listOf(
            Book(listOf(Title("title 1")), listOf("author"), listOf("234"), 5.0),
            Book(listOf(Title("title 0")), listOf("GREAT_AUTHOR"), listOf("123"), 2.5)
        )
