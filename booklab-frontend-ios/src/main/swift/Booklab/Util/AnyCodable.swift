...
public extension KeyedEncodingContainerProtocol {
    ...
    public mutating func encodeIfPresent(_ value: Dictionary<String, Any>?, forKey key: Key) throws {
        if let dict = value {
    ...
    public mutating func encodeIfPresent(_ value: Array<Any>?, forKey key: Key) throws {
        if let array = value {
