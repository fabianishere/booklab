 ...
 * @property client The matcher to cross match the books.
 */
data class VisionConfiguration(val detector: BookDetector, val extractor: TextExtractor, val client: SruClient) {
    companion object {
        /**
